        ...
        return (
          <View style={styles?.stepContainer}>
            ...
            <Text style={styles?.subtitle}>
              Please review and accept our community policies to continue.
            </Text>
            ...
            <View style={styles?.legalBox}>
              ...
              >
                <View
                  style={[
                    styles?.checkbox,
                    agreedLocation && styles?.checkboxChecked,
                  ]}
                >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles?.checkboxDesc}>
                    I consent to sharing my location to find people nearby.
                  </Text>
                </View>
              </TouchableOpacity>
              ...
              >
                <View
                  style={[
                    styles?.checkbox,
                    agreedAge && styles?.checkboxChecked,
                  ]}
                >
        ...
        return (
          <View style={styles?.stepContainer}>
            <View style={styles?.avatarPickerContainer}>
              ...
              <Text style={styles?.avatarPickerDesc}>
              ...
              {POPULAR_INTERESTS.map((interest: InterestTag) => {
                ...
                return (
                  ...
                  >
                    <Text
                      style={[
                        styles?.interestEmoji,
                        isSelected && styles?.interestEmojiSelected,
                      ]}
                    >
                      {interest?.emoji}
                    </Text>
    ...
    <View style={styles?.container}>
      ...
      <View style={styles?.footer}>
        {currentStep < STEPS.length - 1 ? (
          <Button
            label={currentStep === 0 ? "Accept & Continue" : "Continue"}
            onPress={handleNext}
            fullWidth
          />
        ) : (
